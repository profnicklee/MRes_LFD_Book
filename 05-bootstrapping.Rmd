...
Because this chapter now draws its own sample rather than reusing the one still in memory from Chapter \@ref(uncertainty), the exact numbers below may land somewhere slightly different from what we saw there — same unseeded variation as always, not a new inconsistency.
...
Now, let's extend this to the multiple regression case we have previously used in Chapter \@ref(assoc-rel), examining the relationships between smoking, biking, and heart disease.
