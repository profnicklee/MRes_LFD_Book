...
Here, I'll demonstrate the basic application of ANOVA on the simple 3-group case of the Ed Sheeran Study we first met in Chapter \@ref(t-test), and go from there to introduce some classic 'concerns' with the statistical hypothesis testing methodology.
