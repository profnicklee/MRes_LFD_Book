...
```{r}
#NEXT TWO LINES ARE CORRECT ELEGANT WAFFLE CODE, NOT USED IF WAFFLE PACKAGE NOT INSTALLED. IF WAFFLE BECOMES AVAILABLE REINSTATE THEM AND REMOVE UGLY BASE R VERSION BELOW
#x <- c(Hypotheses=100)
#waffle::waffle(x, colors=c("lightgrey"))
#DO NOT UNCOMMENT BELOW LINE EVEN IF USING WAFFLE CODE
#waffle::waffle(c(40, 60), colors=c("blue", "lightgrey")) + guides(fill=FALSE)

#UGLY BASE R CODE BELOW. Note that this is not fully thought through and may contain unnecessary code, i was rushing to solve the waffle problem that was dumped on me. Code taken from https://stats.stackexchange.com/q/143424 and modified by me
...
```{r}
#NEXT THREE LINES ARE CORRECT ELEGANT WAFFLE CODE, NOT USED IF WAFFLE PACKAGE NOT INSTALLED. IF WAFFLE BECOMES AVAILABLE REINSTATE THEM AND REMOVE UGLY BASE R VERSION BELOW. 
#Do NOT uncomment second line even if go back to waffle.
